...
/*Ans b)*/
SELECT 
    DATE_FORMAT(paymentDate, '%M') AS MonthName,
...
ORDER BY 
 ...
 /*QUESTION-07*/
 select Employeenumber,concat(firstname,'',lastname) Employeename,count(distinct customername) customercount from employees
